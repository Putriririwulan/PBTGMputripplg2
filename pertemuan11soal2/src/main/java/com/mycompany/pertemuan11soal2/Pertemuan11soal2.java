...
public class Pertemuan11soal2 {
    ...
    public Pertemuan11soal2(String idKaryawan, String namaKaryawan, String golongan, String jabatan, double gajiPokok) {
    ...
    public static void main(String[] args) {
        ...
        // Membuat objek Pertemuan11soal2 dan mengirim data ke constructor
        Pertemuan11soal2 karyawan = new Pertemuan11soal2(idKaryawan, namaKaryawan, golongan, jabatan, gajiPokok);
